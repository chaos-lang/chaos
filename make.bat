...
%compiler% -Iloops -Ifunctions -Imodules -DCHAOS_INTERPRETER -o chaos.exe parser.tab.c lex.yy.c loops/*.c functions/*.c modules/*.c utilities/*.c ast/*.c interpreter/*.c Chaos.c %extra_flags%
IF errorlevel 1 (
    EXIT /B 1
)
